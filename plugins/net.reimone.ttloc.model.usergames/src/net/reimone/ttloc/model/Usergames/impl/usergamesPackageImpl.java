...
import net.reimone.ttloc.model.Usergames.usergamesFactory;
 ...
 * @generated
 */
public class usergamesPackageImpl extends EPackageImpl implements usergamesPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see net.reimone.ttloc.model.Usergames.usergamesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private usergamesPackageImpl() {
		super(eNS_URI, usergamesFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link usergamesPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static usergamesPackage init() {
		if (isInited) return (usergamesPackage)EPackage.Registry.INSTANCE.getEPackage(usergamesPackage.eNS_URI);

		// Obtain or create and register package
		usergamesPackageImpl theusergamesPackage = (usergamesPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof usergamesPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new usergamesPackageImpl());
		...
		theusergamesPackage.createPackageContents();

		// Initialize created meta-data
		theusergamesPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theusergamesPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(usergamesPackage.eNS_URI, theusergamesPackage);
		return theusergamesPackage;
	}
	 ...
	 * @generated
	 */
	public usergamesFactory getusergamesFactory() {
		return (usergamesFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getSpielType_Nr(), theXMLTypePackage.getInt(), "nr", null, 1, 1, SpielType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getSpielType_Zeit(), theXMLTypePackage.getDateTime(), "zeit", null, 1, 1, SpielType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
